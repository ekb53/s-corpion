...
<section className="container py-12 md:py-16">
    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      <div className="col-span-2">
        ...
        Our tool uses up-to-date data from the Bureau of Labor Statistics and advanced AI algorithms to provide highly accurate estimates. However, these should be used as a guide and not as definitive figures.
        Can I save my reports?
        Yes, you can save reports as templates and name them for easy access in future sessions.
        Is my data secure?
        Absolutely. We use industry-standard encryption and adhere to SOC 2 and GDPR compliance standards.
        How do I delete my data?
        You can request data deletion through our contact form. We will process your request within 30 days.
